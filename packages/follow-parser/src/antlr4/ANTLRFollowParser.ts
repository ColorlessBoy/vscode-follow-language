...
export class ANTLRFollowParser extends Parser {
	...
	public assumeBlock(): AssumeBlockContext {
		...
		try {
			...
			do {
				...
				this._errHandler.sync(this);
				_la = this._input.LA(1);
			} while ((((_la) & ~0x1F) === 0 && ((1 << _la) & ((1 << ANTLRFollowParser.LPAREN) | (1 << ANTLRFollowParser.RPAREN) | (1 << ANTLRFollowParser.COMMA) | (1 << ANTLRFollowParser.ID))) !== 0));
			}
		}
		catch (re) {
			if (re instanceof RecognitionException) {
	...
	public contentBlock(): ContentBlockContext {
		...
		try {
			...
			do {
				...
				this._errHandler.sync(this);
				switch (this._input.LA(1)) {
				case ANTLRFollowParser.KW_ASSUME:
					{
					this.state = 165;
					this.assumeBlock();
					}
					break;
				case ANTLRFollowParser.KW_TARGET:
					{
					this.state = 166;
					this.targetBlock();
					}
				...
				this._errHandler.sync(this);
				_la = this._input.LA(1);
			} while (_la === ANTLRFollowParser.KW_ASSUME || _la === ANTLRFollowParser.KW_TARGET);
			this.state = 171;
	...
	public assumeID(): AssumeIDContext {
		...
		try {
			...
			this.state = 198;
			_la = this._input.LA(1);
			if (!((((_la) & ~0x1F) === 0 && ((1 << _la) & ((1 << ANTLRFollowParser.LPAREN) | (1 << ANTLRFollowParser.RPAREN) | (1 << ANTLRFollowParser.COMMA) | (1 << ANTLRFollowParser.ID))) !== 0))) {
	...
	public static readonly _serializedATN: string =
		"\x03\uC91D\uCABA\u058D\uAFBA\u4F53\u0607\uEA8B\uC241\x03\x1B\xCF\x04\x02" +
		...
		"\x11\xA3\n\x11\r\x11\x0E\x11\xA4\x03\x12\x03\x12\x03\x12\x06\x12\xAA\n" +
		"\x12\r\x12\x0E\x12\xAB\x03\x12\x03\x12\x03\x13\x03\x13\x07\x13\xB2\n\x13" +
		"\f\x13\x0E\x13\xB5\v\x13\x03\x13\x03\x13\x03\x14\x03\x14\x03\x15\x03\x15" +
		...
		"\x03\x1E\x02\x02\x02\x1F\x02\x02\x04\x02\x06\x02\b\x02\n\x02\f\x02\x0E" +
		"\x02\x10\x02\x12\x02\x14\x02\x16\x02\x18\x02\x1A\x02\x1C\x02\x1E\x02 " +
		"\x02\"\x02$\x02&\x02(\x02*\x02,\x02.\x020\x022\x024\x026\x028\x02:\x02" +
		"\x02\x03\x05\x02\f\r\x0F\x0F\x1B\x1B\x02\xC6\x02=\x03\x02\x02\x02\x04" +
		"O\x03\x02\x02\x02\x06S\x03\x02\x02\x02\bV\x03\x02\x02\x02\n\\\x03\x02" +
		"\x02\x02\fc\x03\x02\x02\x02\x0Ej\x03\x02\x02\x02\x10o\x03\x02\x02\x02" +
		"\x12t\x03\x02\x02\x02\x14{\x03\x02\x02\x02\x16}\x03\x02\x02\x02\x18\x7F" +
		"\x03\x02\x02\x02\x1A\x8A\x03\x02\x02\x02\x1C\x97\x03\x02\x02\x02\x1E\x9A" +
		"\x03\x02\x02\x02 \xA0\x03\x02\x02\x02\"\xA6\x03\x02\x02\x02$\xAF\x03\x02" +
		"\x02\x02&\xB8\x03\x02\x02\x02(\xBA\x03\x02\x02\x02*\xBC\x03\x02\x02\x02" +
		",\xBE\x03\x02\x02\x02.\xC0\x03\x02\x02\x020\xC2\x03\x02\x02\x022\xC4\x03" +
		"\x02\x02\x024\xC6\x03\x02\x02\x026\xC8\x03\x02\x02\x028\xCA\x03\x02\x02" +
		"\x02:\xCC\x03\x02\x02\x02<>\x05\x04\x03\x02=<\x03\x02\x02\x02=>\x03\x02" +
		"\x02\x02>I\x03\x02\x02\x02?H\x05\b\x05\x02@H\x05\n\x06\x02AH\x05\f\x07" +
		"\x02BH\x05\x0E\b\x02CH\x05\x10\t\x02DH\x05\x12\n\x02EH\x05\x14\v\x02F" +
		"H\x05\x16\f\x02G?\x03\x02\x02\x02G@\x03\x02\x02\x02GA\x03\x02\x02\x02" +
		...
		"\x02NP\x05\x06\x04\x02ON\x03\x02\x02\x02PQ\x03\x02\x02\x02QO\x03\x02\x02" +
		"\x02QR\x03\x02\x02\x02R\x05\x03\x02\x02\x02ST\x07\x12\x02\x02TU\x07\x11" +
		"\x02\x02U\x07\x03\x02\x02\x02VX\x07\x13\x02\x02WY\x05&\x14\x02XW\x03\x02" +
		"\x02\x02YZ\x03\x02\x02\x02ZX\x03\x02\x02\x02Z[\x03\x02\x02\x02[\t\x03" +
		"\x02\x02\x02\\]\x07\x14\x02\x02]_\x05(\x15\x02^`\x05*\x16\x02_^\x03\x02" +
		"\x02\x02`a\x03\x02\x02\x02a_\x03\x02\x02\x02ab\x03\x02\x02\x02b\v\x03" +
		"\x02\x02\x02cd\x07\x15\x02\x02df\x05(\x15\x02eg\x05,\x17\x02fe\x03\x02" +
		"\x02\x02gh\x03\x02\x02\x02hf\x03\x02\x02\x02hi\x03\x02\x02\x02i\r\x03" +
		"\x02\x02\x02jk\x07\x16\x02\x02kl\x05(\x15\x02lm\x05.\x18\x02mn\x05\x18" +
		"\r\x02n\x0F\x03\x02\x02\x02op\x07\x17\x02\x02pq\x050\x19\x02qr\x05\x1A" +
		"\x0E\x02rs\x05\"\x12\x02s\x11\x03\x02\x02\x02tu\x07\x18\x02\x02uv\x05" +
		"2\x1A\x02vw\x05\x1A\x0E\x02wx\x05\"\x12\x02xy\x07\x0E\x02\x02yz\x05$\x13" +
		"\x02z\x13\x03\x02\x02\x02{|\x07\x06\x02\x02|\x15\x03\x02\x02\x02}~\x07" +
		"\x07\x02\x02~\x17\x03\x02\x02\x02\x7F\x80\x07\f\x02\x02\x80\x85\x05\x1C" +
		"\x0F\x02\x81\x82\x07\x0F\x02\x02\x82\x84\x05\x1C\x0F\x02\x83\x81\x03\x02" +
		"\x02\x02\x84\x87\x03\x02\x02\x02\x85\x83\x03\x02\x02\x02\x85\x86\x03\x02" +
		"\x02\x02\x86\x88\x03\x02\x02\x02\x87\x85\x03\x02\x02\x02\x88\x89\x07\r" +
		"\x02\x02\x89\x19\x03\x02\x02\x02\x8A\x93\x07\f\x02\x02\x8B\x90\x05\x1C" +
		"\x0F\x02\x8C\x8D\x07\x0F\x02\x02\x8D\x8F\x05\x1C\x0F\x02\x8E\x8C\x03\x02" +
		"\x02\x02\x8F\x92\x03\x02\x02\x02\x90\x8E\x03\x02\x02\x02\x90\x91\x03\x02" +
		"\x02\x02\x91\x94\x03\x02\x02\x02\x92\x90\x03\x02\x02\x02\x93\x8B\x03\x02" +
		"\x02\x02\x93\x94\x03\x02\x02\x02\x94\x95\x03\x02\x02\x02\x95\x96\x07\r" +
		"\x02\x02\x96\x1B\x03\x02\x02\x02\x97\x98\x05(\x15\x02\x98\x99\x054\x1B" +
		"\x02\x99\x1D\x03\x02\x02\x02\x9A\x9C\x07\x19\x02\x02\x9B\x9D\x056\x1C" +
		"\x02\x9C\x9B\x03\x02\x02\x02\x9D\x9E\x03\x02\x02\x02\x9E\x9C\x03\x02\x02" +
		"\x02\x9E\x9F\x03\x02\x02\x02\x9F\x1F\x03\x02\x02\x02\xA0\xA2\x07\x1A\x02" +
		"\x02\xA1\xA3\x058\x1D\x02\xA2\xA1\x03\x02\x02\x02\xA3\xA4\x03\x02\x02" +
		"\x02\xA4\xA2\x03\x02\x02\x02\xA4\xA5\x03\x02\x02\x02\xA5!\x03\x02\x02" +
		"\x02\xA6\xA9\x07\b\x02\x02\xA7\xAA\x05\x1E\x10\x02\xA8\xAA\x05 \x11\x02" +
		"\xA9\xA7\x03\x02\x02\x02\xA9\xA8\x03\x02\x02\x02\xAA\xAB\x03\x02\x02\x02" +
		"\xAB\xA9\x03\x02\x02\x02\xAB\xAC\x03\x02\x02\x02\xAC\xAD\x03\x02\x02\x02" +
		"\xAD\xAE\x07\t\x02\x02\xAE#\x03\x02\x02\x02\xAF\xB3\x07\b\x02\x02\xB0" +
		"\xB2\x05:\x1E\x02\xB1\xB0\x03\x02\x02\x02\xB2\xB5\x03\x02\x02\x02\xB3" +
		"\xB1\x03\x02\x02\x02\xB3\xB4\x03\x02\x02\x02\xB4\xB6\x03\x02\x02\x02\xB5" +
		"\xB3\x03\x02\x02\x02\xB6\xB7\x07\t\x02\x02\xB7%\x03\x02\x02\x02\xB8\xB9" +
		"\x07\x1B\x02\x02\xB9\'\x03\x02\x02\x02\xBA\xBB\x07\x1B\x02\x02\xBB)\x03" +
		"\x02\x02\x02\xBC\xBD\x07\x1B\x02\x02\xBD+\x03\x02\x02\x02\xBE\xBF\x07" +
		"\x1B\x02\x02\xBF-\x03\x02\x02\x02\xC0\xC1\x07\x1B\x02\x02\xC1/\x03\x02" +
		"\x02\x02\xC2\xC3\x07\x1B\x02\x02\xC31\x03\x02\x02\x02\xC4\xC5\x07\x1B" +
		"\x02\x02\xC53\x03\x02\x02\x02\xC6\xC7\x07\x1B\x02\x02\xC75\x03\x02\x02" +
		"\x02\xC8\xC9\t\x02\x02\x02\xC97\x03\x02\x02\x02\xCA\xCB\t\x02\x02\x02" +
		"\xCB9\x03\x02\x02\x02\xCC\xCD\t\x02\x02\x02\xCD;\x03\x02\x02\x02\x11=" +
		"GIQZah\x85\x90\x93\x9E\xA4\xA9\xAB\xB3";
...
export class ContentBlockContext extends ParserRuleContext {
	...
	public targetBlock(): TargetBlockContext[];
	public targetBlock(i: number): TargetBlockContext;
	public targetBlock(i?: number): TargetBlockContext | TargetBlockContext[] {
		if (i === undefined) {
			return this.getRuleContexts(TargetBlockContext);
		} else {
			return this.getRuleContext(i, TargetBlockContext);
		}
	}
	constructor(parent: ParserRuleContext | undefined, invokingState: number) {
		super(parent, invokingState);
