...
suite('Follow Parser', () => {
    ...
    assertDocument('type wff', [
      {
        ...
        children: [
          {
            type: NodeType.TypeBlock,
            value: 'type',
            line: 0,
            offset: 0,
            length: 4,
            children: [{ type: NodeType.Name, value: 'wff', line: 0, offset: 5, length: 3, children: [] }],
          },
        ],
      },
    ]);
  ...
  test('ConstBlock', () => {
    assertDocument('const wff true false', [
      {
        type: NodeType.Root,
        value: '',
        line: 0,
  ...
  test('VarBlock', () => {
    assertDocument('var wff w0 w1 w2', [
      {
        type: NodeType.Root,
        value: '',
        line: 0,
  ...
  test('PropBlock', () => {
    assertDocument('prop wff imp and or iif: w0 w1', [
      {
        type: NodeType.Root,
        value: '',
        line: 0,
  ...
  test('AxiomBlock', () => {
    assertDocument('axiom ax-1 : w0 w1 : -| w0 |- imp w1 w0', [
      {
        type: NodeType.Root,
        value: '',
        line: 0,
        ...
        children: [
          {
            ...
            children: [
              ...
              {
                type: NodeType.ProofInput,
                value: '-|',
                line: 0,
                offset: 21,
                length: 2,
                children: [{ type: NodeType.ProofOp, value: 'w0', line: 0, offset: 24, length: 2, children: [] }],
              },
              {
                type: NodeType.ProofOutput,
                value: '|-',
                line: 0,
                offset: 27,
                length: 2,
  ...
  test('TheoremBlock', () => {
    assertDocument('thm thm-1  : w0 w1 : -| w0 |- imp w1 w0 : ax-1', [
      {
        type: NodeType.Root,
        value: '',
        line: 0,
        ...
        children: [
          {
            ...
            children: [
              ...
              {
                type: NodeType.ProofProcess,
                value: '',
                line: 0,
                offset: 42,
                length: 0,
                children: [{ type: NodeType.ProofOp, value: 'ax-1', line: 0, offset: 42, length: 4, children: [] }],
              },
            ],
          },
        ],
          ...
          children: [
            {
              ...
              children: [
                ...
                { type: NodeType.Arg, value: 'w1', line: 1, offset: 42, length: 2, children: [] },
                {
                  ...
                  offset: 47,
                  length: 2,
                  children: [{ type: NodeType.ProofOp, value: 'w0', line: 1, offset: 50, length: 2, children: [] }],
                },
                {
                  type: NodeType.ProofOutput,
                  value: '|-',
                ...
                },
                {
                  ...
                  offset: 68,
                  length: 0,
                  children: [{ type: NodeType.ProofOp, value: 'ax-1', line: 1, offset: 68, length: 4, children: [] }],
                  comments: [
                    {
                      type: NodeType.LineComment,
                      value: '//This is a proof process comment.',
                      line: 2,
                      offset: 73,
                      length: 34,
                      children: [],
